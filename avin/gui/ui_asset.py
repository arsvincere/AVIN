...
from avin.core import Exchange, Type, Asset, Share, AssetList
from avin.company import Tinkoff
from avin.utils import Cmd
from avin.gui.custom import Font, Icon, Palette, ToolButton, Dialog
...
class Tree(QtWidgets.QTreeWidget):
    ...
    def __onAdd(self):
        ...
        if edited_list:
            ...
            logger.info(f"Asset list saved")
...
class Editor(QtWidgets.QDialog):
    ...
    def __markExisting(self, editable):
        ...
        for asset in self.full_alist:
            if asset in editable:
                asset.setCheckState(
                    Tree.Column.Ticker, Qt.CheckState.Checked
                    )
    ...
    def editAssetList(self, editable: IAssetList) -> bool:
        ...
        if result == QtWidgets.QDialog.DialogCode.Accepted:
            ...
            logger.info(f"Cancel edit asset list")
            return False
...
class AssetWidget(QtWidgets.QWidget):
    ...
    def __onToolSection(self):
        ...
        logger.warning(f"This feature is unavailible, it will be added later")
